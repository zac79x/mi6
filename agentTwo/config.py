"""Module-level configuration constants for the agent package.
...
#: JSON.
HTTP_LOG_FILE: str = "agent/agent.http.log"
...
LLM_PAYLOAD_LOG_FILE: str = "agent/agent.llm_payload.log"
...
#: of extensions; :func:`agent.safety.validate_path` accepts any path
...
#: by :func:`agent.diff_tool.configure_diff_tool`. ``None`` means "ask
