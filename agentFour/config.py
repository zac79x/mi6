"""Module-level configuration constants for the agentFour package."""
...
LOG_FILE: str = "agentFour/agent.log"

#: Full request/response bodies with the Ollama endpoint (DEBUG).
HTTP_LOG_FILE: str = "agentFour/agent.http.log"

#: Full JSON payloads sent to the LLM, one block per request (INFO).
LLM_PAYLOAD_LOG_FILE: str = "agentFour/agent.llm_payload.log"
...
#: ``agentFour.diff_tool.configure_diff_tool``; ``None`` means ask
